...
public class PowerChart extends AbstractDemoChart {
	...
	public String getDesc() {
		return "Power Bar Chart for Today";
	}

	public PowerChart(List<double[]> values, String[] labels) {
		this.values = values;
		this.labels = labels;
	}
	...
	public Intent execute(Context context) {
		...
		// color
		int[] colors = new int[] {Color.rgb(217, 74, 56)};
